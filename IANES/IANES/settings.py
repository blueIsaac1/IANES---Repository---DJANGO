"""
Django settings for IANES project.
...
SECRET_KEY = 'django-insecure-i0%v0jfl9!yv&3azd@th7sc_tf&k@+z0@8)id^va^$jhc$-(x1'
...
WSGI_APPLICATION = 'IANES.wsgi.application'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    BASE_DIR / "Main/static",  # Ajuste conforme a estrutura do seu projeto
]
